...
namespace Engine {
    ...
    void Vulkan::createLogicalDevice() {
        ...
        vkGetDeviceQueue(vkLogicalDevice, indices.presentFamily.value(), 0, &presentQueue);
    }
    ...
    void Vulkan::createGraphicsPipeline() {
        ...
        if (vkCreateGraphicsPipelines(vkLogicalDevice, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
    ...
    void Vulkan::drawFrame() {
        ...
        uint32_t imageIndex;
        VkResult result = vkAcquireNextImageKHR(vkLogicalDevice, swapChain, UINT64_MAX, imageAvailableSemaphores[currentFrame], VK_NULL_HANDLE, &imageIndex);
    ...
    void Vulkan::createIndexBuffer() {
        VkDeviceSize bufferSize = sizeof(indices[0]) * 3;
